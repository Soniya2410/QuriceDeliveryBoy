...
public class CancelledOrderFragment extends Fragment {
    ...
    LoadingDots loader;
    @BindView(R.id.cancelledOrderRecylerView)
    RecyclerView cancelledOrderRecylerView;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View cancelledOrderView = inflater.inflate(R.layout.fragment_cancelled_order, container, false);
        mContext = getContext();
        ButterKnife.bind(this,cancelledOrderView);
        ((HomeActivity)mContext).getSupportActionBar().setTitle("Cancelled Order");
        ...
        if(Constant.isConnected(mContext))
        {
            if(userID!=0) {
                ...
                cancelOrderList(userID);
            }
        }
        return cancelledOrderView;
    }
    private void cancelOrderList(int userID){
        try {
            Log.e(TAG,"USer ID "+userID);

            Call<ResponseBody> call = api.deliveryOrdersList(userID,"cancelled");
                        ...
                        if (response.isSuccessful()) {
                            ...
                            if (js.getInt("code") == 200) {
                                ...
                                if(listOfOrder.size()>0){
                                    ...
                                    cancelledOrderRecylerView.setAdapter(orderAdapter);
                                }else{

...
public class DeliveryOrderFragment extends Fragment {
    ...
    LoadingDots loader;
    @BindView(R.id.deliveryOrderRecylerView)
    RecyclerView deliveryOrderRecylerView;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View deliveryOrderView = inflater.inflate(R.layout.fragment_delivery_order, container, false);
        mContext = getContext();
        ButterKnife.bind(this,deliveryOrderView);
        ((HomeActivity)mContext).getSupportActionBar().setTitle("Delivery Order");
        ...
        if(Constant.isConnected(mContext))
        {
            if(userID!=0) {
                ...
                deliveryOrderList(userID);
            }
        }
        return deliveryOrderView;
    }
    private void deliveryOrderList(int userID){
        try {
            Log.e(TAG,"USer ID "+userID);

            Call<ResponseBody> call = api.deliveryOrdersList(userID,"delivered");
            Log.d(TAG, "deliveryOrderList List post Url " + call.request().url());
                        ...
                        if (response.isSuccessful()) {
                            ...
                            if (js.getInt("code") == 200) {
                                ...
                                for(int i = 0;i<jsonArray.length();i++){
                                    ...
                                    orderPojo.setOrderStatus("delivery");
                                ...
                                if(listOfOrder.size()>0){
                                    ...
                                    deliveryOrderRecylerView.setAdapter(orderAdapter);
                                }else{
